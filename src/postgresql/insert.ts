...
client.query(
    "INSERT INTO student (student_id,name,email,birthdate,gender)VALUES (1,'Ankit','ankitpatel11@gmail.com','2002-09-01','Male'),(2,'Bansi','bansi125@gmail.com','2001-06-23','Female'),(3,'Hiren','hirenpatodiya03@gmail.com','2003-10-23','Male'),(4,'Rutvi','rutvizalavadiya@gmail.com','2002-01-10','Female'),(5,'Nirbhay','nirbhaypatel55@gmail.com','2001-04-29','Male');", (err, res) => {
    if (err) {
        console.error(err);
        return;
    }
